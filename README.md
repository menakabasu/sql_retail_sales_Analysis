...
```
11. **Write a SQL query to create Highest Revenue Category**:
```sql
select
			category,
			 Revenue
		from 
		 ...
		 WHERE rank=1;
```
12. **Write a SQL query to create Customer Age Group Analysis**:
```sql
 select
...
- **LinkedIn**: [https://www.linkedin.com/in/menaka-narayanasamy-8a5588a1/]
-	https://github.com/menakabasu/sql_retail_sales_Analysis
